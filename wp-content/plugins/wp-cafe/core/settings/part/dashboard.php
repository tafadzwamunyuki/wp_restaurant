    ...
    <div class="wpc-row wpc-align-items-center">
        ...
        <div class="wpc-col-md-5">
            <div class="wpc-label-item wpc-report-item wpc-mb-0">
                ...
                <div class="wpc-meta">
                    <label for="wpc-settings-channel" class="wpc-label-top"><?php echo esc_html__('Channel','wpcafe'); ?></label>
                    <select class="wpc-settings-input wpc_chart_type wpc-input-dark" id="wpc-settings-channel">
                ...
                <div class="wpc-meta wpc-meta-double-date">
                    <label for="wpc-settings-timeline" class="wpc-label-top"><?php echo esc_html__('Timeline','wpcafe'); ?></label>
                    <input type="text" value="" data-date_range="" class="wpc_date_picker wpc-settings-input attr-form-control" id="wpc-settings-timeline" placeholder="<?php esc_attr_e('April 01, '.date("Y").' - April 31, '.date("Y").'', 'wpcafe' ); ?>" />
                </div>
